...
The device had a dimension of 120 x 131 x 207 mmˆ3 with the weight of 0.832 kg.
...
The clinical diagnosis of metabolic diseases, such as diabetes mellitus, highly depends on the measurement of glucose in body fluid.
The number of people suffering from diabetes is rising, and there is over 1 in 10 adults are affected worldwide.
By 2045, 780 million people worldwide are predicted to live with diabetes\cite{b1}.
Diabetes patients are at a higher risk of critical health problems than non-diabetic individuals.
As a result, accurate monitoring of blood glucose concentrations in diabetic patients is crucial for real-time diabetes diagnosis.
...
While the first group is glucose specific, the latter is broadly adaptable and can be used to detect not only glucose but a wide variety of other carbohydrates as well\cite{b2}.
...
In particular, the development of spectrophotometric and colorimetric glucose assays has taken advantage of the activities of glucose oxidase and hexokinase enzyme\cite{b2}.
...
In colorimetric assays, studies revealed that the Horseradish Peroxidase (HRP) enzyme could catalyze the reaction of H2O2 and organic substrates such as 3,3',5,5'-tetramethylbenzidine (TMB) to produce visible colors\cite{b3}. 

Microfluidics offer several advantages for glucose analysis, such as reduced sample and reagent consumption, faster analysis, portability, and high compatibility with multiplexing detection means\cite{b4,b5}.
...
The platform is based on the droplet manipulation using electrowetting-on-dielectric (EWOD) principle which applies electric potential to the control electrodes coated with a hydrophobic dielectric\cite{b4}.
The DMF system mainly consists of a fluid layer located between the top and bottom plates. Nowadays, DMF technology is commonly used for various processes which include sample preparation and diagnostics\cite{b6}.
...
\begin{itemize}
    ...
    \item Portable (should be smaller than 420 x 300 x 180 mmˆ3 and weighs less than 2 kg)
\end{itemize}
...
Beer-Lambert's law, expressed in Equation (\ref{beer-lambert}), serves as the basis for quantitative analyses using both atomic and molecular absorption measurements ($\epsilon$) is the molar attenuation coefficient)\cite{b7}.
...
The battery can be recharged with a 12 V adapter whenever the battery voltage is insufficient. 
...
The power from the adapter is converted into 8.4 V (full capacity) using a charging module when charging is needed.
The power subsystem is activated when the user presses the power button for the first time—allowing the 8.4 V to flow from the battery or the adapter(when charging) to the DC step-down module, giving 6 V output to the microcontroller and other loads. 
...
\subsection{Accuracy}
Glucose samples were prepared using a glucose assay kit (Glucose (GO) Assay Kit, Sigma-Aldrich\cite{b8}) with concentration of 40 {\textmu}g/ml and 60 {\textmu}g/ml.
...
These effeciency drops caused low intensity readouts for blank measurements, which increased resolution and noise in lower wavelengths.
...
During the implementation and testing process, it was shown that for each adjustment done for troubleshooting causes a shift in the component. 
Light pathway obscured by other components cause a reduction in the light intensity which passes through the sample.
...
This way, the light path length is constant. Other than that, the droplet's shape, which tends to be convex at the top, can cause lensing effect\cite{b5}.
...
Weight measurement is done by placing the device on a digital scale which shows the weight of 0.832 kilograms. 
The final dimension of the spectrophotometer are 120 x 131 x 207 mmˆ3, as shown in Fig. \ref{device_dimensions}
...
The battery has a size of 70 x 42 x 21 mmˆ3, which significantly affects the determination of the minimum area of the base.
...
\bibitem{b1} “IDF Diabetes Atlas Tenth edition.” [Online]. Available: https://diabetesatlas.org/. [Accessed: 12-Dec-2022]. 
\bibitem{b2} A. L. Galant, R. C. Kaufman, and J. D. Wilson, “Glucose: Detection and analysis,” Food Chemistry, vol. 188, pp. 149–160, 2015. 
\bibitem{b3} H. V. Tran et al., “Silver nanoparticles-decorated reduced graphene oxide: A novel peroxidase-like activity nanomaterial for development of a colorimetric glucose biosensor,” Arabian Journal of Chemistry, vol. 13, no. 7, pp. 6084–6091, Jul. 2020, doi: 10.1016/j.arabjc.2020.05.008.
\bibitem{b4} Z. Gu, M. L. Wu, B. Y. Yan, H. F. Wang, and C. Kong, “Integrated Digital Microfluidic Platform for Colorimetric Sensing of Nitrite,” ACS Omega, vol. 5, no. 19, pp. 11196–11201, May 2020, doi: 10.1021/acsomega.0c01274.
\bibitem{b5} R. B. Fair, A. Khlystov, V. Srinivasan, V. K. Pamula, and K. N. Weaver, “Integrated Chemical/biochemical sample collection, pre-concentration, and analysis on a digital microfluidic lab-on-a-chip platform,” SPIE Proceedings, 2004. 
\bibitem{b6} S. Huang and R. B. Fair, “Quantitative measurements of inorganic analytes on a digital microfluidics platform,” SN Applied Sciences, vol. 1, no. 12, Dec. 2019, doi: 10.1007/s42452-019-1693-8.
\bibitem{b7} D. A. Skoog, F. J. Holler, and S. R. Crouch, Principles of Instrumental Analysis, 7th ed. Cengage Learning, 2016.
\bibitem{b8} B. E. Raabo and T. C. Terkildsen, “On the enzymatic determination of blood glucose,” Scandinavian Journal of Clinical and Laboratory Investigation, vol. 12, no. 4, pp. 402–407, 1960. 
\end{thebibliography}
