...
\subsection{Accuracy}
Glucose samples are prepared using a glucose assay kit (Glucose (GO) Assay Kit, Sigma-Aldrich\cite{b6}) with concentration of 40 {\textmu}g/ml and 60 {\textmu}g/ml concentration.
...
a layer of silicon oil, a layer of stretched parafilm, and a layer of indium-tin oxide (ITO) coated glass above the droplet. 
