...
\begin{figure}[htbp]
    \centerline{\includegraphics[scale=0.25]{glucosetransmittanceALL.png}}
...
\begin{figure}[htbp]
    \centerline{\includegraphics[scale=0.25]{glucose_peakwavelength.png}}
...
Fig. \ref{lcd-spec} illustrates how the result and spectrum page of the absorbance measurement is shown.
    ...
    \begin{figure}[htbp]
    \centerline{\includegraphics[scale=0.6]{lcd-spec.JPEG}}
...
The user should click the REGRESS button to calculate the concentration of the unknown sample and view the standard curve plot (Fig. \ref{lcd-conc}).
    ...
    \begin{figure}[htbp]
    \centerline{\includegraphics[scale=0.6]{lcd-conc.JPEG.}}
